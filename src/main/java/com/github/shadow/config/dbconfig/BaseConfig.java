//package com.github.shadow.config.dbconfig;
//
...
//    /**
//     *
//     * minimumIdle 控制连接池空闲连接的最小数量，当连接池空闲连接少于minimumIdle，而且总共连接数不大于maximumPoolSize时，HikariCP会尽力补充新的连接。
...
//     *
//     * maximumPoolSize 此属性控制允许池到达的最大大小，包括空闲和使用中的连接。基本上，此值将确定到数据库后端的实际连接的最大数量。 对此的合理值最好由您的执行环境决定。
//     * 当池达到此大小且没有空闲连接可用时，对getConnection（）的调用将connectionTimeout在超时前阻塞最多毫秒。 请阅读有关游泳池尺寸的信息。 默认值：10
//     */
